...
export default function Login() {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      ...
      toast({
        title: 'OTP failed',
        description: 'Could not send OTP. Check backend logs/provider.',
        variant: 'destructive',
      });
    }
  };
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div className="mt-6 p-4 bg-slate-50 rounded-xl border border-slate-200">
              ...
              <div className="space-y-2 text-sm">
                <button
                  type="button"
                  onClick={() => fillCredentials('admin@officegate.com', 'ChangeMe@12345')}
                ...
                <button
                  type="button"
                  onClick={() => fillCredentials('security@officegate.com', 'ChangeMe@12345')}
                  className="w-full flex items-center justify-between p-2 bg-white rounded-lg hover:bg-indigo-50 hover:border-indigo-200 border border-transparent transition-all cursor-pointer text-left"
                >
                  <div>
                ...
                <button
                  type="button"
                  onClick={() => fillCredentials('tenant@officegate.com', 'ChangeMe@12345')}
